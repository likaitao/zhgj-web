                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" id="page-sidebar-menu">
                       ...
                       <li class="start active">
                        ...
                        <li class="">
                            <a href="javascript:;">
                                <i class="fa fa-gears"></i><span class="title"> 基础数据 </span><span
                                class="arrow "> </span>
                            </a>
                            <ul class="sub-menu">
                                <li>
                        ...
                        <li class="">
                        	<a href="javascript:;">
                                <i class="fa fa-reorder"></i><span class="title"> 销售订单 </span>
                            </a>
                        </li>
                        
                        <li class="">
                        	<a href="javascript:;">
                                <i class="fa fa-envelope"></i><span class="title"> 采购订单 </span>
                            </a>
                        </li>
                        
                        <li class="">
                        	<a href="javascript:;">
                                <i class="fa fa-film"></i><span class="title"> 库存 </span>
                            </a>
                        </li>
                        
                        <li class="">
                        	<a href="javascript:;">
                                <i class="fa fa-star"></i><span class="title"> 对账单 </span>
                            </a>
                        </li>
                        
                        <li class="">
                        	<a href="javascript:;">
                                <i class="fa fa-times"></i><span class="title"> 收付款 </span>
                            </a>
                        </li>
                        
                        <li class="">
                        	<a href="javascript:;">
                                <i class="fa fa-signal"></i><span class="title"> 发票 </span>
                            </a>
                        </li>
